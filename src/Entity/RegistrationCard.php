...
class RegistrationCard
{
    ...
    #[ORM\Column(length: 800, nullable: true, type: "text", options: ["default" => "La résiliation du gage se fera quelle que soit la qualité du débiteur, conformément aux dispositions de l'article 93 du code de commerce."])]
